    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="small mb-4" style="text-align: center">
                    untuk bisa masuk ke Nduwe Gawe, buat akun Anda terlebih dahulu dengan mengisi form di bawah ini.
                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="nohp" type="number"
                                   ...
                                   value="{{ old('nohp') }}" required autocomplete="email">
